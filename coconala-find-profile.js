...
(async () => {
  ...
  for (const url of urls) {
    ...
    if (textareas.length > 0) {
      ...
      await page.screenshot({ path: '/home/USER/projects/new-project/coconala-found.png', fullPage: false });
      break;
    }
  }
  ...
  await page.screenshot({ path: '/home/USER/projects/new-project/coconala-mypage.png', fullPage: false });
