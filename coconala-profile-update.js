const { chromium } = require('/home/USER/projects/mercari-bot/node_modules/playwright');
const SESSION_DIR = '/home/USER/.coconala-session';
...
(async () => {
  ...
  await page.screenshot({ path: '/home/USER/projects/new-project/coconala-prof-edit.png' });
  ...
  if (!filled) {
    ...
    await page.waitForTimeout(3000);
    console.log('URL:', page.url());
    await page.screenshot({ path: '/home/USER/projects/new-project/coconala-user-info.png' });
    filled = await fillProfileText(page);
  }

  if (filled) {
    await page.screenshot({ path: '/home/USER/projects/new-project/coconala-filled.png' });
