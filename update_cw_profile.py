...
async def main():
    async with async_playwright() as p:
        ...
        await page.wait_for_load_state("domcontentloaded")
        await page.screenshot(path="/mnt/c/Users/USER/Downloads/cw_edit_page.png")
        ...
        if textarea is None:
            ...
            await page.screenshot(path="/mnt/c/Users/USER/Downloads/cw_edit_debug.png")
            await browser.close()
            return
        ...
        await page.screenshot(path="/mnt/c/Users/USER/Downloads/cw_after_save.png")
