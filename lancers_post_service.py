...
# 実際の表示: "n8n×AIで業務プロセスを自動化｜月20時間削減保証パッケージます"
TITLE = "n8n×AIで業務プロセスを自動化｜月20時間削減保証パッケージ"
SUBTITLE = "繰り返し作業・手動コピペ・レポート作成をn8n+AIで丸ごと自動化します"
...
・自動化設計書の作成
・n8n + AI（GPT/Claude）による自動化構築
・テスト・納品・操作マニュアル付き
・導入後サポート（1週間）"""

# 業務内容（詳細説明）
BUSINESS_CONTENT = """【n8n×AI】で繰り返し作業を丸ごと自動化します
